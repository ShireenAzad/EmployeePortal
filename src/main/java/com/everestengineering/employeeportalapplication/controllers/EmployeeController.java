...
public class EmployeeController {
    ...
    @GetMapping("")
    public EmployeesData getAllEmployeesOnSortingFields(@PageableDefault(page = 0, size = 2, sort = {"firstName","lastName","dateOfJoin"}, direction = Sort.Direction.ASC) Pageable pageable) {
